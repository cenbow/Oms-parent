 ...
 * 订单金额调整：查询列表
 */
Ext.define('MB.view.orderAmountAdjustment.OrderAmountAdjustmentGridView', {
	extend : "Ext.grid.Panel",
	alias : 'widget.orderAmountAdjustmentGridView',
	store: "MB.store.OrderAmountAdjustmentStore",
	selModel : new Ext.selection.CheckboxModel(),
	id : 'orderAmountAdjustmentGridView',
	autoRender:true,
	columnLines: true,
	width: '100%',
	...
	initComponent : function() {
		...
		me.columns = [
		    ...
		    { header: '批次号', dataIndex: 'billNo',width: 160,align: 'center'},
		    { header: '渠道号', dataIndex: 'channelCode',hidden: true},
	...
	downloadRecord:function(record){
		...
		if(billNo==''||billNo==null){
			 ...
			 window.location.href = basePath + 'custom/orderAmountAdjustment/downloadRecord.spmvc?billNo='+billNo;
		}
	},
	checkDetail:function(record){
		...
		//store的请求路径
		var url = basePath +'custom/orderAmountAdjustment/getOrdAmoAjuDetailList.spmvc?billNo='+billNo;
		//模型
		...
		var grid = Ext.create('Ext.grid.Panel',{
			...
			columns : [
					    ...
					    { header: '外部交易号', dataIndex: 'orderCode',width: 150,align: 'center'},
						{ header: '调整金额', dataIndex: 'money',width: 100,align: 'center'},
						{ header: '处理结果', dataIndex: 'resultMsg',width: 295,align: 'center',
