Ext.define('MB.controller.TurnNormalOrderController', {
	extend : 'Ext.app.Controller',
	stores : [ 'OrderCustomDefines'],
	models : [ 'OrderCustomDefine'],
	views : [ 'orderDetail.TurnNormalOrder' ],
	refs : [],
	init : function() {
	},
	onLaunch : function() {
		...
		Ext.Ajax.request({
			...
			params: {'masterOrderSn' : parent.masterOrderSn, 'method' : 'init'},
			success: function(response){
				...
				var win = Ext.widget("turnNormalOrder");
				win.show();
			},
