...
var questionDataByImportStoreList = null;

var questionDataUrl = basePath + "/custom/define/customDefineList.spmvc";
createAjaxDataBySyn("questionDataBy", questionDataUrl, doSuccessfun, doFailurefun, {"type":3,"display":1}, 100000);

function doSuccessfun(id, response, opts) {
	if("questionDataBy"==id){
		...
		questionDataByImportStoreList =arr;
...
//问题单原因
Ext.define("MB.store.QuestionStoreByImport", {
	extend: "Ext.data.Store",
	model: "MB.model.OrderCustomDefine",
	data: questionDataByImportStoreList
});
