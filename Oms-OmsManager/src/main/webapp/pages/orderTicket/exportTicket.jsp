	...
	Ext.onReady(function() {
		...
		Ext.create('Ext.form.Panel', {
			...
			items : [ {
				...
				html:'<a id="importTemplateFile" style="color:red" href = "'+ basePath+'custom/downloadTemp.spmvc?path=' +encodeURI( encodeURI('/pages/excelModel/订单结算单.xls'))+'">下载导出模板文件（简体中文）</a>'
			} ],
			buttons : [ {
						...
						form.submit({
							success : function(f, action) {
								if (action.result.success  == "true") {
										...
										parent.parent.orderTicketJsonStore.getProxy().url= basePath+"/custom/orderSettleBill/orderBillList.spmvc";
										parent.parent.orderTicketJsonStore.load();
