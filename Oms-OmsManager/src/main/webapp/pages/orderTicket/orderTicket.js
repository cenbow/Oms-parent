	...
	var selModel = Ext.create('Ext.selection.CheckboxModel', {
		...
		/*listeners: {
			selectionchange: function(sm, selections, aa) {
				orderTicketGrid.down('#confirmButton').setDisabled((selections.length === 0 || batchConfirmAuth));
			}
		}*/
...
//	orderTicketJsonStore = createObjectGridStoreLazy(orderSettleBillListUrl, pageSize, "MB.OrderSettleBill");
	...
	var dItems = [{
		...
		items: [
			...
			//	disabled: ButtonDis(toNormal),
				handler : function() {
					FormEditWin.showAddDirWin("popWins",basePath+"/custom/orderSettleBill/createOrderSettleBill.spmvc?method=init",
...
//				disabled: ButtonDis(addQuestion),
				handler : function() {
					FormEditWin.showAddDirWin("popWins",basePath+"/custom/orderSettleBill/gotoOrderMoneyImportPage.spmvc",
							"importOrderLogistics_winID","订单财务金额调整",800,414);
				}
			}
	    ]
	}];
