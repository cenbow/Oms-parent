...
/**********************************	*/
	...
	//'1,预付款，2保证金',
	returnSettlementTypeOptionCombo = createComboBoxLocal(returnSettlementTypeDataStore,'orderDepositReturnSettlementType', 'n','v', 'local','退款结算状态', 230, 100, 'returnSettlementType', '请选择');
	
	var returnSettlementType = $("#returnSettlementType").val();
	
	if(null != returnSettlementType && "" != returnSettlementType){
		returnSettlementTypeOptionCombo.setValue(returnSettlementType);
		Ext.getCmp('orderDepositReturnSettlementType').setDisabled(true);
	}
...
//	}
	...
	//	{ id : 'billNo', header : "单据批次号", align : "center", width : 835, dataIndex:'billNo', sortable:false}//,
		{ id : 'orderCode', header : "退单号", align : "center", width : 835, dataIndex : 'orderCode', sortable:false}//,
		...
		items: [
			...
			//	disabled: true,
				...
				handler : function() {
					...
					FormEditWin.showAddDirWin("popWins",basePath+"/custom/orderSettleBill/enterExportDepositPage.spmvc?billNo="+billNo,
