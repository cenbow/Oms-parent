...
<html>
	...
	<body>
		...
		<!-- 预付款和保证金  -->
		<input type="hidden" id="returnSettlementType" name="returnSettlementType" value="${returnSettlementType}"/>
	...
	<script type="text/javascript" src="<%=basePath%>/pages/deposit/addOrderDeposit.js"></script>
</html>