...
public class OrderItemConstant {
	 ...
	 * 共用标志
	 */
	public static final int OS_NO = 0; /* 0 否 */
	public static final int OS_YES = 1; /* 1 是 */
	public static final int OS_ERROR = -1; /* -1 失败 */
	
	public static final String OS_STR_NO = "0"; /* 0 失败*/
	public static final String OS_STR_YES = "1"; /* 1 成功*/
	/**
	 * 订单锁定状态
	 */
	...
	public static final String OS_BEGIN_WITH_FH = "FH"; /* 发货单单号开头字母 */
	public static final String OP_BEGIN_WITH_FK = "FK"; /* 付款单单号开头字母 */
	public static final String OP_BEGIN_WITH_MFK = "MFK"; /* 合并付款单单号开头字母 */
	public static final String OR_BEGIN_WITH_TD = "TD"; /* 退单单号开头字母 */
	public static final String RS_BEGIN_WITH_TH = "TH"; /* 退货单单号开头字母 */
	public static final String RP_BEGIN_WITH_TK = "TK"; /* 退款单单号开头字母 */

	/**
	 * order_info.order_status: 订单状态
	 */
	public static final int OI_ORDER_STATUS_UNCONFIRMED = 0; /* 0，未确认 */
	public static final int OI_ORDER_STATUS_CONFIRMED = 1; /* 1，已确认 */
	public static final int OI_ORDER_STATUS_CANCLED = 2; /* 2，已取消 */
	public static final int OI_ORDER_STATUS_FINISHED = 3; /* 3，完成 */
	 ...
	 * 0，未发货、1备货中、2，部分发货、3，已发货、4，部分收货、5，客户已收货
	 */
	...
	/**
	 * order_info.question_status 问题单状态
	 * 1,问题单、0,正常单
	 */
	 ...
	 * 0 正常、1 挂起
	 */
	public static final int OI_PROCESS_STATUS_NORMAL = 0;
	public static final int OI_PROCESS_STATUS_SUSPENDED = 1;

	/**
	 * order_info.notice_status 通知收款状态
	 * 0 未通知、1 已通知
	 */
	public static final int OI_NOTICE_STATUS_UNNOTICED = 0;
	public static final int OI_NOTICE_STATUS_NOTICED = 1;
	...
	/**
	 * order_pay.pay_status 支付状态
	 */
	public static final int OP_PAY_STATUS_UNPAYED = 0; /* 0，未付款 */
	public static final int OP_PAY_STATUS_PAYING = 1; /* 1，付款中 */
	public static final int OP_PAY_STATUS_PAYED = 2; /* 2，已付款 */
	public static final int OP_PAY_STATUS_SETTLED = 3; /* 3，已结算 */
	public static final int OP_PAY_STATUS_COMFIRM = 4; /* 4，待确认 */
	/**
	 * 
	 */
	 ...
	 */
	public static final int OS_SHIPPING_STATUS_UNSHIPPED = 0; /* 0，未发货 */
	public static final int OS_SHIPPING_STATUS_SHIPPED = 1; /* 1，已发货 */
	public static final int OS_SHIPPING_STATUS_RECEIVED = 2; /* 2，已收货 */
	public static final int OS_SHIPPING_STATUS_PREPARING = 3; /* 3，备货中 */
	public static final int OS_SHIPPING_STATUS_CONFIRM=13;/* 13 客户确认收货*/
	 ...
	 */
	public static final int OR_RETURN_TYPE_RETURN = 1; /* 1退货单 */
	public static final int OR_RETURN_TYPE_REJECT = 2; /* 2拒收入库单 */
	public static final int OR_RETURN_TYPE_REFUND = 3; /* 3退款单 */
	public static final int OR_RETURN_TYPE_EXREFUND = 4; /* 额外退款单 */
	public static final int OR_RETURN_TYPE_LOSERETURN = 5; /* 失货退货单 */
	/**
	 * order_return.process_type 处理状态
	 */
	public static final int OR_PROCESS_TYPE_NOOP = 0; /* 0无操作 */
	public static final int OR_PROCESS_TYPE_RETURN = 1; /* 1退货 */
	public static final int OR_PROCESS_TYPE_EXCHANGE = 2; /* 2换货 */
	...
	/*****************split_status*****************/
	public static final Byte SPLIT_STATUS_UNSPLITED = 0; // 未拆单
	public static final Byte SPLIT_STATUS_SPLITTING = 1; // 拆单中
	public static final Byte SPLIT_STATUS_SPLITED = 2; // 已拆单
	public static final Byte SPLIT_STATUS_RESPLITED = 3; // 重新拆单
	 ...
	 * OD_表示交货单
	 */
	public static final Byte OD_ORDER_STATUS_UNCONFIRMED = 0;//未确认
	public static final Byte OD_ORDER_STATUS_CONFIRMED = 1;//已确认
	public static final Byte OD_ORDER_STATUS_CANCLED = 2;//已取消
	public static final Byte OD_ORDER_STATUS_FINISHED = 3;//已完成
	
	/**
	 * order_distribute.ship_status 发货总状态
	...
	/**
	 * order_distribute.source
	 * 0:未处理;1:POS(全流通);2:云货架(YHJ);3:线上订单(B2C);4:C2M;5:C2B、6平台闪购标识
	 * OD_表示交货单
	 */
	...
	public static final int OD_SOURCE_BG = 6;
	...
	/**
	 * master_order_info.source 0:未处理;1:POS(全流通);2:云货架(YHJ);3:线上订单(B2C);4:C2M;5:C2B
	 * mo_表示主单
	 */
	 ...
	 * 操作人
	 */
	public static final String ACTION_USER_ADMIN = "admin";
}
