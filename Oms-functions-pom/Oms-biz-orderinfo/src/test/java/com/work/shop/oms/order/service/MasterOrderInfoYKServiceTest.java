...
//		reference.setUrl("json://192.168.155.204:8089/Oms/dubbo/com.work.shop.oms.order.service.MasterOrderInfoService");
		
//		reference.setUrl("json://172.31.249.149:8080/Oms/dubbo/com.work.shop.oms.order.service.MasterOrderInfoService");
		reference.setUrl("json://192.168.1.5:9010/Oms/dubbo/com.work.shop.oms.order.service.MasterOrderInfoService");
//		reference.setUrl("dubbo://10.8.35.115:6689");
//		reference.setInterface("com.work.shop.oms.order.service.MasterOrderInfoService");
...
//		masterOrder.setExpectedShipDate(expectedShipDate);
		...
		goodsList.add(createMasterGoods("10008000010", "XXXXX", "/sources/images/goods/TP/810743/810743_41_09.jpg", 189D, 100D, 0D, 1, "common","10911A01109B"));
//		goodsList.add(createMasterGoods("80000110023", "美唇笔", "/sources/images/goods/TP/810743/810743_41_09.jpg", 1D, 1D, 0D, 1, "common","10911A01109A"));
		...
		masterPays.add(createMasterPay(1, "alipay", 0, 110D));
