...
public class MasterOrderInfoBgListServiceTest extends TestCase {

	private ApplicationConfig application = null;
	private ReferenceConfig<MasterOrderInfoService> reference;
	private String orderFrom = "C0000001";
	private String referer = "克丽缇娜WAP商城";
...
//		reference.setUrl("json://192.168.2.48:8089/Oms/dubbo/com.work.shop.oms.order.service.MasterOrderInfoService");
		reference.setUrl("json://47.97.56.90:8010/Oms/dubbo/com.work.shop.oms.order.service.MasterOrderInfoService");
...
//		goodsList.add(createMasterGoods("20209599141", "男长袖衬衫", "/sources/images/goods/TP/810743/810743_41_09.jpg", 659D, 60D, 0D, 1, "common"));
		goodsList.add(createMasterGoods("8300210000", "美唇笔", "/sources/images/goods/TP/810743/810743_41_09.jpg", 100D, 80D, 0D, 1, "common"));
...
//		cardInfos.add(createGoodsCardInfo("22233330152", 100D, 80D, null));
		...
		masterPays.add(createMasterPay(1, "alipay", payStatus, 80D));
...
//		Double totalPayable = totalFee - moneyPaid - surplus - bonus;
	...
	private List<MasterShip> createMasterShip(List<MasterGoods> goodsList, List<GoodsCardInfo> cardInfos) {
		...
		masterShip.setUserCardName("");
		masterShip.setUserCardNo("");
